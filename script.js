...
document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", (e) => {
    ...
    const data1 = document.getElementsByClassName("name").value;
    const data2 = document.getElementsByClassName("eMail").value;
    const data3 = document.getElementsByClassName("title").value;
    const data4 = document.getElementsByClassName("sum").value;
    const data5 = document.getElementsByClassName("address").value;
    const data6 = document.getElementsByClassName("description").value;
    ...
    fetch("/submit-data", {
      ...
      body: `data=${(data1, data1, data3, data4, data5, data6)}`,
    })
